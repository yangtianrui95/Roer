...
import ytr.roer.L;
import ytr.roer.NetworkResponse;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    protected Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        ...
        synchronized (sDecodeLock) {
            try {
                ...
                L.e("Caught OOM for %d byte image, url=%s", response.data.length, getUrl());
                return Response.error(new RoerError(e));
            }
        }
    }
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            return Response.error(new RoerError(response));
        } else {
