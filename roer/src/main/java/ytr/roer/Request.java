...
import ytr.roer.policy.impl.DefaultRetryPolicy;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    private CachePolicy.Entry mCacheEntry = null;
     ...
     * @return This Request object to allow for chaining.
     */
    public Request<?> setCacheEntry(CachePolicy.Entry entry) {
        mCacheEntry = entry;
        return this;
    }
     ...
     */
    public CachePolicy.Entry getCacheEntry() {
        return mCacheEntry;
    }
     ...
     * attempts remaining, this will cause delivery of a {@link } error.
     */
     ...
     *
     * @param roerError the error retrieved from the network
     * @return an NetworkError augmented with additional information
     */
    protected RoerError parseNetworkError(RoerError roerError) {
        return roerError;
    }
     ...
     */
    public void deliverError(RoerError error) {
